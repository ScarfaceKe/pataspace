...
import { getRegistrationResponsibilityCopy, ADDITIONAL_FLOOR_LOCATIONS, type PropertyOwnershipRole, type PropertyRegistrationAction, type AdditionalFloorLocationId } from '@/domain/property-registration';
